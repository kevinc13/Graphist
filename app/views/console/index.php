...
<body>
	...
	<section class="content-wrapper console-wrapper">
		<header>Welcome, <?php echo $_SESSION["name"];?></header>
		<form id="editor">
			<textarea id="query" name="query" placeholder="Cypher Query..."></textarea>
		</form>
	</section>
	<!-- End Content Wrapper -->
	
	<script src="public/js/codemirror/lib/codemirror.js"></script>
	<script src="public/js/codemirror/addon/display/placeholder.js"></script>
